...
// random_name.php
// Usage example: random_name.php?gender=male
...
// --- Gender Input ------------------------------------------------------------
$gender = isset($_GET['gender']) ? strtolower($_GET['gender']) : 'male';
...
// Output
echo json_encode(["gender" => $gender, "name" => $fullName], JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);
